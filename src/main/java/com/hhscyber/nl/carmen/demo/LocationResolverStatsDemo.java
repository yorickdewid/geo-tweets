...
import com.hhscyber.nl.carmen.utils.Timer;
...
/**
 * A demo of the LocationResolver that computes statistics about the locations
 * in the given tweets. The geolocated tweets are written out to a new file.
        ...
        while (scanner.hasNextLine()) {
            ...
            for (Object jry1 : jry) {
                ...
                try {
                    ...
                    HashMap<String, Object> readValue = (HashMap<String, Object>) mapper.readValue(jry1.toString(), Map.class);
                    tweet = readValue;
